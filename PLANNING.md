...
- **ingest_pageindex.py**: Uploads PDFs to the VectifyAI PageIndex cloud API

### 3. Database Schema (`/sql`)
- **schema.sql**: PostgreSQL schema with pgvector (schema is applied directly; there is no migrations framework)
